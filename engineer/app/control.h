 ...
 public:
  ...
  struct Deposit_t {
    ...
    float deposit_above[2][6] = {
        {2.65, -1.74, 0.51, 0, 1.22, -0.7},  // left
        {-2.65, -1.74, 0.51, 0, 1.22, 0.7},  // right
    };
    // 存矿吸盘
    float deposit[2][6] = {
        {2.65, -1.54, 0.69, 0, 0.86, -0.7},  // left
        {-2.65, -1.54, 0.69, 0, 0.86, 0.7},  // right
    };
  ...
  struct Withdraw_t {
    ...
    float withdraw_front[2][6] = {
        {1.77, -1.68, 1.18, -1.41, -1.37, 0.47},   // left
        {-1.77, -1.68, 1.18, 1.41, -1.37, -0.47},  // right
    };
    // 存矿吸盘
    float withdraw[2][6] = {
        {2.48, -1.40, 0.92, -0.88, -1.09, 0.39},   // left
        {-2.48, -1.40, 0.92, 0.88, -1.09, -0.39},  // right
    };
    // 存矿吸盘上方
  ...
  struct TriplePick_t {
    ...
    Matrixf<3, 1> mine_offset[3] = {
        ...
        Matrixf<3, 1>((float[3]){-0.1, 0.3, 0.07}),
    };
    // 3矿坐标
    Pose_t mine[3];
    // 矿上方坐标
    Pose_t mine_prepare[3];
    // 中间点坐标
